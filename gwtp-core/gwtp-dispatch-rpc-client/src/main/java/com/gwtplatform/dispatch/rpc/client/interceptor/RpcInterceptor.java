 ...
 */
public interface RpcInterceptor<A, R> {
    /**
     ...
     *                    following the undo.
     * @return A {@link DispatchRequest} object. Never return {@code null}, instead return a new {@link
     * com.gwtplatform.dispatch.client.CompletedDispatchRequest} if you executed, cancelled or ignored the action.
     */
